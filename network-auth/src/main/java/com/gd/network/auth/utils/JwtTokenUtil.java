package com.gd.network.auth.utils;
...
public class JwtTokenUtil {
     ...
     * token前缀
     */
    public static final String TOKEN_PREFIX = "network ";
    ...
    public JwtTokenUtil() throws Exception {
        secretKey = RsaUtils.getSecretKey("/Users/binbini/Documents/workspace/NetworkProgram/auth_key/id_key");
    }
